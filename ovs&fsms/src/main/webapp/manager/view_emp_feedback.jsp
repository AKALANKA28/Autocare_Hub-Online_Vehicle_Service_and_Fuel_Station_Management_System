...
<%@page import="com.feedback.EmployeeFeedback"%>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-3 text-center">Employee Feedback</p>
    ...
    <table class="table">
        ...
        <tbody>
            <%
                ...
                List<EmployeeFeedback> feedbacks = dao.getAllEmployeeFeedback();
